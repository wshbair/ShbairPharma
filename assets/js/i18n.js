...
var translations = {
  en: {
    ...
    manage_providers_btn: 'Manage Providers',
    ...
    perm_categories: 'Manage Providers and Invoices',
    ...
    server_port_lbl: 'Server Port*',
    till_number_lbl: 'Till Number*',
    hardware_id_lbl: 'Hardware ID',
    save_settings_val: 'Save Settings',
    license_key_lbl: 'License Key*',
    test_connection_btn: 'Test Connection',
    bind_host_lbl: 'Bind Address',
    bind_lan: '0.0.0.0 — All interfaces (LAN)',
    bind_local: '127.0.0.1 — Local only',
    detected_lan_ip_lbl: 'Detected LAN IP',
    connection_url_lbl: 'Connection URL (give to Terminals)',
    regenerate_btn: 'Regenerate',
    firewall_hint: 'Allow inbound TCP on the listen port in your firewall.',
  ...
  ar: {
    ...
    manage_providers_btn: 'إدارة الموردين',
    ...
    server_port_lbl: 'منفذ الخادم*',
    till_number_lbl: 'رقم الصراف*',
    hardware_id_lbl: 'معرّف الجهاز',
    save_settings_val: 'حفظ الإعدادات',
    license_key_lbl: 'مفتاح الترخيص*',
    test_connection_btn: 'اختبار الاتصال',
    bind_host_lbl: 'عنوان الربط',
    bind_lan: '0.0.0.0 — جميع الواجهات (شبكة محلية)',
    bind_local: '127.0.0.1 — محلي فقط',
    detected_lan_ip_lbl: 'عنوان IP المحلي المكتشف',
    connection_url_lbl: 'رابط الاتصال (للأجهزة الطرفية)',
    regenerate_btn: 'إعادة توليد',
    firewall_hint: 'اسمح بمنفذ TCP الوارد في جدار الحماية.',
    conn_testing: 'جارٍ الاختبار…',
    conn_ok: 'متصل',
    conn_failed: 'فشل الاتصال',
    net_status_online: 'متصل',
    net_status_offline: 'غير متصل',
